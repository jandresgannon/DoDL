...
uk_pact+log_uk_arms+log_uk_troops+uk_vis+uk_ex+uk_nukes
...
factors=1, data=d,
lambda.constraints = list(uk_pact=list(2,"+")),
...
write.csv(lambda,file="lambda_uk.csv")
write.csv(phi,file="country_irt_uk.csv")
