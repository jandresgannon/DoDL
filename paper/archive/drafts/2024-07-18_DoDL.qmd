...
format:
  pdf:
    ...
    output-ext:  "pdf"
    fig-format: png
    thanks: The author is thankful to many who provided feedback on earlier and related drafts, especially Abhit Bhandari, Steven Brooks, Rosella Cappella Zielinski, Jonathan Caverley, Joshua Clinton, Benjamin Fordham, Erik Gartzke, Brenton Kenkel, Nadiya Kostyuk, Kendrick Kuo, David Lake, Nicole R. Letourneau, Jonathan Markowitz, Sara Plana, Abigail Post, Philip Roeder, Erik Sand, Kaija Schilde, Ryan Shandler, Branislav Slantchev, Bradley C. Smith, Jennifer Spindel, and Sanne Verschuren. Excellent research assistance was provided by the Vanderbilt University Research on Conflict and Collective Action (ROCCA) Lab and the UC San Diego Center for Peace and Security Studies (cPASS). This project benefited from financial support from the Smith Richardson Foundation, the Stand Together Trust, and the APSA Centennial Center.
...
execute:
  ...
  message: false
  cache: true
abstract: \singlespacing \noindent How can groups successfully ally with one another when the costs of coordination and the risks of opportunism are high? While a pervasive political problem, this issue is particularly pernicious in international alliances where the capabilities, preferences, and incentives of states vary tremendously. I argue states can overcome the problems this heterogeneity creates by forming alliances that have high strategic compatibility and are hierarchical. Strategic compatibility and hierarchy allows states to minimize the risk of opportunism and cost of coordination by efficiently distributing defense capabilities across actors. This incentivizes complementarity in national military capabilities rather than creating alliances of redundant national militaries with overlapping capabilities. I show the applicability of my argument by developing a novel network-level measure of division of labor and applying it to data on disaggregated national military capabilities to characterize the nature of defensive alliances from 1970 to 2014. Beyond the obvious implications for better understanding the nature of the modern international system, my work also highlights the importance of similar considerations for inter-group alliances in politics more generally.
header-includes:
- \usepackage{tikz}
- \usepackage{pgfplots}
...
The collective action problem is one of the most enduring dilemmas in political science, posing a longstanding challenge to theories of cooperation and coordination among groups [@olson_logiccollectiveaction_1965; @hardin_collectiveaction_1982]. At its core, it highlights the difficulty of organizing collective efforts in the face of individual incentives to defect. How can a group of actors who would benefit from working together toward a common goal minimize the risk of opportunism and the cost of coordination that otherwise threaten the feasibility of cooperation? Whether and how actors overcome collective action problems has important implications for a wide variety of social behaviors. Actors successfully overcoming opportunism and coordination costs can consequently provide public goods, use comparative advantage to efficiently allocate resources, and strengthen sustainable community cohesion.

Opportunism and coordination costs are rarely minimized incidentally. Instead, they are addressed through conscious choices by agents within favorable environments. Successful collective action has been observed in cases with formal (often coercive) enforcement mechanisms, compliance-inducing side payments, and trust stemming from strong social ties [@ostrom_behavioralapproachrational_1998]. In situations where actors collectively contribute resources toward a common goal, cooperation is not optimal simply because actors *aggregate* individual member capabilities [@olson_economictheoryalliances_1966]. Ideally, participants would efficiently *divide* among themselves the responsibilities that those capabilities require. A division of labor over the capabilities each actor contributes to the common good is evidence of efficiency gains made possible by comparative advantage. However, familiar problems arise when deciding what capabilities each partner should bring to the table, as actors have to consider the risks inherent in coordinating collective decisions that depend on possible defectors [@niou_alliancesanarchicinternational_1994].

The goal of this study is to explain how groups can collectively align in ways that minimize opportunism and coordination costs in the context of international defense cooperation. The collective action problem is particularly pronounced here, as the stakes involve coercive military threats, and cooperation requires trust and commitment over public goods in the absence of externally enforceable mandates [@axelrod_achievingcooperationanarchy_1985]. Although defense alliances have been observed throughout history, their existence alone is insufficient evidence that collective action problems have been resolved. Such cooperation could be epiphenomenal if it simply reflects the interests of states rather than changing their behavior [@mearsheimer_falsepromiseinternational_1994; @downs_goodnewscompliance_1996], or if such cooperation leaves actors worse off because of opportunistic behavior like free-riding, abandonment, or entrapment [@snyder_securitydilemmaalliance_1984; @palmer_marginalutilitycooperation_1990].

I argue that the composition of defense portfolios in military alliances provides evidence about ways in which state cooperation can minimize opportunism and enhance collective action. How can states reap the efficiency gains of specializing their military portfolio if doing so leaves them vulnerable in the event their partner does not show up on the battlefield? Alliances exhibit significant variation in *how* they aggregate defense capabilities to improve collective and individual security, with some alliances consisting of member states with complementary military capabilities and other alliances involving overlapping and redundant national force structures. Differences in the degree to which alliances divide the capabilities they aggregate cannot be fully explained by economic or geographic factors alone; political considerations play a crucial role.

Drawing from organizational behavior research on inter-firm collaboration, I develop a theory of security cooperation that emphasizes the importance of strategic compatibility and hierarchy. Strategic compatibility, or the degree to which states agree about the nature of the international threat environment, creates compatible payoff structures that increase the efficiency of joint warfighting force. Hierarchical alliances, characterized by an asymmetric distribution of influence over security decisions, are better equipped to resolve information asymmetries and harmonize interoperability standards. By reducing opportunism and coordination costs, alliances with these two characteristics are more successful at efficiently allocating defense capabilities across actors through complementary defense portfolios that minimize redundancy through a division of labor.

To test this theory, I analyze the distribution of disaggregated national military capabilities across alliance members from 1970 to 2014 [@leeds_alliancetreatyobligations_2002; @gannon_planestrainsarmored_2023]. Using these data, I develop a new index adapted from statistical ecology to measure division of labor as the complementarity of military capabilities across alliance members while also improving state of the art measures of strategic compatibility [@leeds_interestsinstitutionsreliability_2009; @poast_arguingalliancesart_2019] and hierarchy [@beardsley_hierarchyprovisionorder_2020]. Consistent with theoretical expectations, I find evidence across a variety of statistical models indicating that alliances with high strategic compatibility and more hierarchical structures exhibit a greater division of labor, suggesting that these factors enable mutually interdependent cooperation by mitigating opportunism and coordination costs.

This study advances our understanding of several key issues in international politics. First, it contributes to discussions about whether alliances and armaments act as substitutes or complements [@morrow_armsalliestradeoffs_1993; @diehl_substitutescomplementseffects_1994], suggesting that the composition of armaments within alliances is influenced by the compatibility of member security interests and the centralization of decision-making control. The efficacy of military spending can only be understood in the context of what that money is spent on, and this is particularly true of allies whose spending could be high but superfluous or low but effectual. Second, it addresses the debate over the efficacy of alliances in improving security and stability [@kimball_politicalsurvivalpolicy_2010; @blankenship_burdensharingdilemmacoercive_2023], offering a novel mechanism -- complementarity -- by which allies can pool distinctly specialized capabilities to improve the efficiency of defense spending [@gannon_alliesarmamentsexplaining_2024].

The argument is organized as follows. @sec-lit reviews existing explanations for how states improve their security through arming and allying. @sec-theory details the theory of a shared production model of security, explaining how strategic compatibility and hierarchy can overcome the collective action problem to allow a division of labor in defense capabilities. @sec-empirics presents a quantitative empirical test of this theory using cross-national data on disaggregated military capabilities from 1970 to 2014. @sec-conclusion concludes with a discussion of the implications of these findings for theories about collective action and conflict and offers suggestions for future research. Third, it challenges the foundational view that states behave as like-units due to the ability to use force and the absence of central authority [@stein_coordinationcollaborationregimes_1982; @posen_sourcemilitarydoctrine_1984], demonstrating instead that functional differentiation occurs when aligned states adopt different roles and responsibilities through cooperation [@bukovansky_specialresponsibilitiesglobal_2012, 6-7].

# Existing explanations for cooperative security {#sec-lit}

A well-established literature has theorized that the two ways a state can develop a military response to foreign threats are internal balancing (arming) and external balancing (allying).[^1] Both strategies share the same primary motivation: security. States develop arms as a military response to foreign threats [@conybeare_armsalliancescapital_1994; @goldman_internationalcompetitionmilitary_2007; @nordhaus_effectsinternationalsecurity_2012] and at their core, military alliances are fundamentally an agreement about when and how to fight [@niou_externalthreatinternal_2019; @poast_arguingalliancesart_2019]. Other positive externalities can motivate both arming and allying, and these incentives may in some cases be more salient, but an expectation of improved security is a necessary condition.[^2]
...
Neither arming nor allying is a strictly dominant strategy for improving security across all circumstances and contingencies. Investing in arms (internal balancing) provides more certain access to defense capabilities, but it is slower and more costly since resources devoted to guns are resources a state is not devoting to butter [@powell_gunsbutteranarchy_1993; @clark_tradingbutterguns_2001; @poast_sinewwarpolitical_2019]. On the other hand, while allying with like-minded states (external balancing) accesses defense capabilities more quickly and allows more resources to be devoted to domestic issues, security decisions may now be at a whim of others on whom you now rely and may have to defend when you otherwise would not [@snyder_securitydilemmaalliance_1984; @walt_originsalliances_1987].
...
The theoretical merits of this assumption and conflicting empirical findings are due to inattention to the *composition* of arms aggregated across defense alliances. Efforts to examine the composition of alliance military capabilities have still largely homogenized alliances to compare them to non-alliances [@becker_disaggregateddefensespending_2024; @gannon_alliesarmamentsexplaining_2024] or black-boxed arming by aggregating defense as spending [@alley_allianceparticipationtreaty_2021] or institutional design [@margulies_patronspersonnelforeign_2021; @kostyuk_alliesdiffusionstate_2024]. As a result, the state of the art insufficiently explains why states facing a common threat vary in how they aggregate distinct capabilities against that threat.

What factors shape whether an alliance can reliably engaging in collective action and how does that change the strategic composition of arms across allied states?[^3] Understanding this phenomenon is a worthwhile endeavor, as how each state contributes to collective security has long been [@olson_economictheoryalliances_1966; @christensen_chaingangspassed_1990; @palmer_corrallingfreerider_1990; @snyder_alliancepolitics_1997], and remains, a central question in international politics [@fuhrmann_whenleadersfreeride_2020; @blankenship_burdensharingdilemmacoercive_2023; @kinne_freeridingnetwork_2023]. Differences in how alliances bring military resources together has important implications for the outcome of conflict [@conybeare_alternativecollectivegoodsmodels_1994; @bensahel_internationalalliancesmilitary_2007; @cappellazielinski_supplyingalliespolitical_2021; @lanoszka_militaryalliancestwentyfirst_2022, 118-123] as well as the political and economic costs of defense production [@hartley_publicprocurementcompetitiveness_1987; @devestel_defencemarketsindustries_1995; @gannon_alliesarmamentsexplaining_2024].
