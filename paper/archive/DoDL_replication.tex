...
This log file was last compiled on 2025-04-24 using the following
system:
...
\begin{verbatim}
                                          ...
                                          "6.11.0-24-generic" 
                                                      version 
"#24-Ubuntu SMP PREEMPT_DYNAMIC Fri Mar 14 18:13:56 UTC 2025" 
                                                     nodename 
                                                    "fuegito" 
                                                      machine 
                                                     "x86_64" 
...
loaded via a namespace (and not attached):
 [1] compiler_4.4.0    fastmap_1.2.0     cli_3.6.4         tools_4.4.0      
...
\NormalTok{required\_packages }\OtherTok{\textless{}{-}} \FunctionTok{c}\NormalTok{(}
  \StringTok{"knitr"}\NormalTok{, }\StringTok{"kableExtra"}\NormalTok{, }\StringTok{"ggplot2"}\NormalTok{, }\StringTok{"ggtext"}\NormalTok{, }\StringTok{"magrittr"}\NormalTok{, }\StringTok{"rstan"}\NormalTok{, }\StringTok{"igraph"}\NormalTok{, }\StringTok{"ggraph"}\NormalTok{, }\StringTok{"tidygraph"}\NormalTok{,}
  \StringTok{"base64enc"}\NormalTok{, }\StringTok{"digest"}\NormalTok{, }\StringTok{"evaluate"}\NormalTok{, }\StringTok{"glue"}\NormalTok{, }\StringTok{"highr"}\NormalTok{, }\StringTok{"htmltools"}\NormalTok{, }\StringTok{"jsonlite"}\NormalTok{, }\StringTok{"markdown"}\NormalTok{, }\StringTok{"mime"}\NormalTok{,}
  \StringTok{"rmarkdown"}\NormalTok{, }\StringTok{"stringi"}\NormalTok{, }\StringTok{"stringr"}\NormalTok{, }\StringTok{"xfun"}\NormalTok{, }\StringTok{"yaml"}\NormalTok{, }\StringTok{"here"}\NormalTok{, }\StringTok{"centiserve"}\NormalTok{, }\StringTok{"rio"}\NormalTok{, }\StringTok{"ordbetareg"}\NormalTok{,}
  \StringTok{"cmdstanr"}\NormalTok{, }\StringTok{"collapse"}\NormalTok{, }\StringTok{"tinytex"}\NormalTok{, }\StringTok{"brms"}\NormalTok{, }\StringTok{"lmerTest"}\NormalTok{, }\StringTok{"broom"}\NormalTok{, }\StringTok{"marginaleffects"}\NormalTok{, }\StringTok{"modelsummary"}
\NormalTok{)}

\CommentTok{\# Function to install missing packages}
\NormalTok{install\_if\_missing }\OtherTok{\textless{}{-}} \ControlFlowTok{function}\NormalTok{(packages) \{}
\NormalTok{  installed }\OtherTok{\textless{}{-}} \FunctionTok{installed.packages}\NormalTok{()}
  \ControlFlowTok{for}\NormalTok{ (pkg }\ControlFlowTok{in}\NormalTok{ packages) \{}
    \ControlFlowTok{if}\NormalTok{ (}\SpecialCharTok{!}\NormalTok{(pkg }\SpecialCharTok{\%in\%} \FunctionTok{rownames}\NormalTok{(installed))) \{}
      \FunctionTok{message}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Installing:"}\NormalTok{, pkg))}
      \FunctionTok{install.packages}\NormalTok{(pkg, }\AttributeTok{dependencies =} \ConstantTok{TRUE}\NormalTok{)}
\NormalTok{    \} }\ControlFlowTok{else}\NormalTok{ \{}
      \FunctionTok{message}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"Already installed:"}\NormalTok{, pkg))}
\NormalTok{    \}}
\NormalTok{  \}}
\NormalTok{\}}

\CommentTok{\# Install required packages}
\FunctionTok{install\_if\_missing}\NormalTok{(required\_packages)}
\end{Highlighting}
\end{Shaded}

\begin{verbatim}
Already installed: knitr
\end{verbatim}

\begin{verbatim}
Already installed: kableExtra
\end{verbatim}
...
\begin{verbatim}
Already installed: ggtext
\end{verbatim}

\begin{verbatim}
Already installed: magrittr
\end{verbatim}

\begin{verbatim}
Already installed: rstan
\end{verbatim}

\begin{verbatim}
Already installed: igraph
\end{verbatim}

\begin{verbatim}
Already installed: ggraph
\end{verbatim}

\begin{verbatim}
Already installed: tidygraph
\end{verbatim}

\begin{verbatim}
Already installed: base64enc
\end{verbatim}

\begin{verbatim}
Already installed: digest
\end{verbatim}

\begin{verbatim}
Already installed: evaluate
\end{verbatim}

\begin{verbatim}
Already installed: glue
\end{verbatim}

\begin{verbatim}
Already installed: highr
\end{verbatim}

\begin{verbatim}
Already installed: htmltools
\end{verbatim}

\begin{verbatim}
Already installed: jsonlite
\end{verbatim}
...
\begin{verbatim}
Already installed: mime
\end{verbatim}

\begin{verbatim}
Already installed: rmarkdown
\end{verbatim}

\begin{verbatim}
Already installed: stringi
\end{verbatim}

\begin{verbatim}
Already installed: stringr
\end{verbatim}

\begin{verbatim}
Already installed: xfun
\end{verbatim}

\begin{verbatim}
Already installed: yaml
\end{verbatim}
...
\begin{verbatim}
Already installed: centiserve
\end{verbatim}

\begin{verbatim}
Already installed: rio
\end{verbatim}

\begin{verbatim}
Already installed: ordbetareg
\end{verbatim}
...
\begin{verbatim}
Already installed: collapse
\end{verbatim}

\begin{verbatim}
Already installed: tinytex
\end{verbatim}

\begin{verbatim}
Already installed: brms
\end{verbatim}

\begin{verbatim}
Already installed: lmerTest
\end{verbatim}

\begin{verbatim}
Already installed: broom
\end{verbatim}

\begin{verbatim}
Already installed: marginaleffects
\end{verbatim}

\begin{verbatim}
Already installed: modelsummary
\end{verbatim}

\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\CommentTok{\# Special handling for cmdstanr {-} Install CmdStan if needed}
\ControlFlowTok{if}\NormalTok{ (}\StringTok{"cmdstanr"} \SpecialCharTok{\%in\%} \FunctionTok{installed.packages}\NormalTok{()[, }\StringTok{"Package"}\NormalTok{]) \{}
  \FunctionTok{library}\NormalTok{(cmdstanr)}
  \ControlFlowTok{if}\NormalTok{ (}\FunctionTok{is.null}\NormalTok{(}\FunctionTok{cmdstan\_version}\NormalTok{())) \{}
    \FunctionTok{message}\NormalTok{(}\StringTok{"CmdStan not found. Installing CmdStan..."}\NormalTok{)}
    \FunctionTok{install\_cmdstan}\NormalTok{()}
\NormalTok{  \} }\ControlFlowTok{else}\NormalTok{ \{}
    \FunctionTok{message}\NormalTok{(}\FunctionTok{paste}\NormalTok{(}\StringTok{"CmdStan version found:"}\NormalTok{, }\FunctionTok{cmdstan\_version}\NormalTok{()))}
\NormalTok{  \}}
\NormalTok{\} }\ControlFlowTok{else}\NormalTok{ \{}
  \FunctionTok{message}\NormalTok{(}\StringTok{"cmdstanr package is not installed. Skipping CmdStan installation."}\NormalTok{)}
\NormalTok{\}}
\end{Highlighting}
\end{Shaded}
...
\begin{verbatim}
- CmdStan path: /home/andresgannon/.cmdstan/cmdstan-2.34.1
\end{verbatim}
...
\begin{verbatim}
Found '/home/andresgannon/bin/tlmgr', which indicates a LaTeX distribution may have existed in the system.
\end{verbatim}

\begin{verbatim}
Error in tinytex::install_tinytex(): If you want to force installing TinyTeX anyway, use tinytex::install_tinytex(force = TRUE).
\end{verbatim}
...
\pandocbounded{\includegraphics[keepaspectratio]{DoDL_replication_files/figure-pdf/fig1-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{DoDL_replication_files/figure-pdf/fig2-1.png}}

\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\NormalTok{filedirectoryfig2 }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(here}\SpecialCharTok{::}\FunctionTok{here}\NormalTok{(), }\StringTok{\textquotesingle{}/data/dyad\_threat.rds\textquotesingle{}}\NormalTok{)}
\NormalTok{shared }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\AttributeTok{file =}\NormalTok{ filedirectoryfig2) }\SpecialCharTok{|\textgreater{}}
...
\begin{Shaded}
\begin{Highlighting}[numbers=left,,]
\NormalTok{filedirectoryfig3 }\OtherTok{\textless{}{-}} \FunctionTok{paste0}\NormalTok{(here}\SpecialCharTok{::}\FunctionTok{here}\NormalTok{(), }\StringTok{\textquotesingle{}/data/sipri\_dyad{-}year.rds\textquotesingle{}}\NormalTok{)}
\NormalTok{network }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\AttributeTok{file =}\NormalTok{ filedirectoryfig3) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{sipri }\OtherTok{\textless{}{-}} \FunctionTok{readRDS}\NormalTok{(}\AttributeTok{file =}\NormalTok{ filedirectoryfig3) }\SpecialCharTok{|\textgreater{}}
\NormalTok{  dplyr}\SpecialCharTok{::}\FunctionTok{filter}\NormalTok{(year }\SpecialCharTok{==} \DecValTok{1975}\NormalTok{) }\SpecialCharTok{|\textgreater{}}
...
\NormalTok{nato }\OtherTok{\textless{}{-}}\NormalTok{ rio}\SpecialCharTok{::}\FunctionTok{import}\NormalTok{(}\FunctionTok{paste0}\NormalTok{(here}\SpecialCharTok{::}\FunctionTok{here}\NormalTok{(), }\StringTok{"/inst/extdata/atop5\_1m.csv"}\NormalTok{)) }\SpecialCharTok{|\textgreater{}}
...
\begin{verbatim}
Error: No such file: /home/andresgannon/rex Dropbox/Andres Gannon/Academic/02_Research/DoDL/inst/extdata/atop5_1m.csv
\end{verbatim}
...
\subsection{In-text results describing figure
4}\label{in-text-results-describing-figure-4}
...
\pandocbounded{\includegraphics[keepaspectratio]{DoDL_replication_files/figure-pdf/fig4-1.png}}
...
\pandocbounded{\includegraphics[keepaspectratio]{DoDL_replication_files/figure-pdf/fig4-2.png}}
